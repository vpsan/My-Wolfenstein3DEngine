...
int	vldthn_map_coordinates_space(t_cube3D *cube, int i, int j)
{
...
int	vldthn_map_coordinates_02NSWE(t_cube3D *cube, int i, int j)
{
...
int	vldthn_map_coordinates(t_cube3D *cube, int i, int j)
{
