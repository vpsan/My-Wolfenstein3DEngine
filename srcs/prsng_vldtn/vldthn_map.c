...
/*   Updated: 2021/04/18 15:08:32 by bhatches         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "prsng_vldtn.h"

int	vldthn_map_coordinates_space(t_game *cube, int i, int j)
{
...
int	vldthn_map_coordinates_02NSWE(t_game *cube, int i, int j)
{
